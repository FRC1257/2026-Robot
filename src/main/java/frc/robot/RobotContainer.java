...
public class RobotContainer {
  ...
  public Command coralIntake() {
    return coralIntake.ManualCommand(CoralIntakeConstants.CORAL_INTAKE_IN_VOLTAGE).withTimeout(2);
  }
  ...
  public Command coralOuttake() {
    return coralIntake.ManualCommand(CoralIntakeConstants.CORAL_INTAKE_OUT_VOLTAGE).withTimeout(2);
  }
  ...
  public Command fullL1() {
    return (goToL1().andThen(coralOuttake())).andThen(stow());
  }

  public Command fullL2() {
    return (goToL2().andThen(coralOuttake())).andThen(stow());
  }
